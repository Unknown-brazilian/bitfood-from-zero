          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                const Text('Painel do Restaurante', style: TextStyle(color: AppColors.textGrey)),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(labelText: 'Username', filled: true, fillColor: Colors.white, border: OutlineInputBorder()),
                ),
                const SizedBox(height: 12),
                TextField(
