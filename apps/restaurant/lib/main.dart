...
void main() async {
  ...
  runApp(RestaurantApp(localeProvider: localeProvider));
}

class RestaurantApp extends StatelessWidget {
  final LocaleProvider localeProvider;
  const RestaurantApp({super.key, required this.localeProvider});
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              const Text('Painel do Restaurante', style: TextStyle(color: Color(0xFFF7931A), fontSize: 13, letterSpacing: 1)),
